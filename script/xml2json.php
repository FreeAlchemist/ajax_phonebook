...
// End of function transformXmlStringToJson
    ...
    public static function convertSimpleXmlElementObjectIntoArray($simpleXmlElementObject,
        ...
        if (is_object($simpleXmlElementObject) and get_class($simpleXmlElementObject)
                == SIMPLE_XML_ELEMENT_PHP_CLASS) {
        ...
        if (is_array($simpleXmlElementObject)) {
            ...
            foreach ($simpleXmlElementObject as $key => $value) {
                ...
                $recursionDepth++;
                $resultArray[$key] = xml2json::convertSimpleXmlElementObjectIntoArray($value,
                                $recursionDepth);
